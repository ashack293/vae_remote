...
$_VAE['local_newest_version'] = "0.6.10";
...
$_VAE['safe_params'] = array(
  ...
  'api/site/v1/store/orders/update' => array('tax', 'shipping', 'discount', 'discount_code', 'shipping_method', 'tax_rate', 'status', 'shipment_company', 'shipment_tracking_number', 'billing_address', 'billing_address_2', 'billing_city', 'billing_company', 'billing_country', 'billing_name', 'billing_phone', 'billing_state', 'billing_zip', 'email', 'shipping_address', 'shipping_address_2', 'shipping_city', 'shipping_company', 'shipping_country', 'shipping_method', 'shipping_name', 'shipping_phone', 'shipping_state', 'shipping_zip'),
  'api/site/v1/store_discount_codes/create' => array('code', 'country', 'custom', 'description', 'discount_shipping', 'fixed_amount', 'free_shipping', 'max_per_customer', 'min_order_amount', 'min_order_items', 'number_available', 'percentage_amount', 'start_at', 'stop_at', 'voucher', 'included_classes', 'excluded_classes', 'required_classes'),
  'api/site/v1/store_discount_codes/update' => array('code', 'country', 'custom', 'description', 'discount_shipping', 'fixed_amount', 'free_shipping', 'max_per_customer', 'min_order_amount', 'min_order_items', 'number_available', 'percentage_amount', 'start_at', 'stop_at', 'voucher', 'included_classes', 'excluded_classes', 'required_classes'),
