...
$_VAE['local_newest_version'] = "0.7.2";
...
$_VAE['safe_params'] = array(
  'api/site/v1/customer_addresses/create' => array('address_type', 'name', 'company', 'address', 'address_2', 'city', 'state', 'zip', 'country', 'phone'),
  'api/site/v1/customers/forgot' => array('name', 'e_mail_address', 'forgot_email_html', 'forgot_email_text', 'brand_name'),
  'api/site/v1/customers/update' => array('name', 'e_mail_address', 'password', 'dob', 'gender', 'banned', 'tags_add', 'tags_input', 'tags_remove', 'billing_name', 'billing_company', 'billing_address', 'billing_address_2', 'billing_city', 'billing_state', 'billing_zip', 'billing_country', 'billing_phone', 'shipping_name', 'shipping_company', 'shipping_address', 'shipping_address_2', 'shipping_city', 'shipping_state', 'shipping_zip', 'shipping_country', 'shipping_phone', 'comment', 'comment_name', 'brand_name'),
  'api/site/v1/customers/update_subscription' => array('amount','description','internal_name'),
  'api/site/v1/customers/create_or_update' => array('name', 'e_mail_address', 'password', 'dob', 'gender', 'banned', 'tags_add', 'tags_input', 'tags_remove', 'billing_name', 'billing_company', 'billing_address', 'billing_address_2', 'billing_city', 'billing_state', 'billing_zip', 'billing_country', 'billing_phone', 'shipping_name', 'shipping_company', 'shipping_address', 'shipping_address_2', 'shipping_city', 'shipping_state', 'shipping_zip', 'shipping_country', 'shipping_phone', 'comment', 'comment_name', 'brand_name', 'gateway_customer_id'),
  'api/site/v1/store/create_order/nested/line_items' => array('backstage_notes', 'barcode', 'brand', 'bundled_with', 'category', 'discount_class', 'discount_reason', 'image', 'inventory_field', 'name', 'notes', 'option_id', 'options', 'original_price', 'position', 'price', 'qty', 'tax', 'total', 'row_id'),
  'api/site/v1/store/create_order' => array('customer_id', 'subtotal', 'tax', 'shipping', 'discount', 'discount_code', 'shipping_method', 'payment_method', 'tax_rate', 'status', 'billing_address', 'billing_address_2', 'billing_city', 'billing_company', 'billing_country', 'billing_name', 'billing_phone', 'billing_state', 'billing_zip', 'email', 'shipping_address', 'shipping_address_2', 'shipping_city', 'shipping_company', 'shipping_country', 'shipping_method', 'shipping_name', 'shipping_phone', 'shipping_state', 'shipping_zip', 'payment_method', 'gateway_transaction_id', 'gateway_customer_id', 'marketing_campaign', 'marketing_content', 'marketing_keyword', 'marketing_medium', 'marketing_source', 'store_logo', 'store_name', 'total', 'weight', 'packing_slip_html', 'order_confirmation_email_html', 'order_confirmation_email_text', 'order_received_email_html', 'order_received_email_text', 'order_waiting_for_approval_email_html', 'order_waiting_for_approval_email_text', 'shipping_info_email_html', 'shipping_info_email_text', 'skip_emails', 'remote_addr', 'cc_number', 'cc_type', 'cc_issue_number', 'cc_start_month', 'cc_start_year', 'cc_month', 'cc_year', 'cc_cvv', 'payer_id', 'token', 'notes', 'line_items', 'stored_payment_method','subscription_amount','subscription_days','subscription_description','subscription_name','subscription_status', 'brand_name'),
  'api/site/v1/store/orders/add_line_items' => array('line_items'),
  'api/site/v1/store/orders/add_line_items/nested/line_items' => array('backstage_notes', 'barcode', 'brand', 'bundled_with', 'category', 'discount_class', 'discount_reason', 'image', 'inventory_field', 'name', 'notes', 'option_id', 'options', 'original_price', 'position', 'price', 'qty', 'tax', 'total', 'row_id'),
  'api/site/v1/store/orders/create_comment' => array('comment','name'),
  'api/site/v1/store/orders/update' => array('fulfilled', 'tax', 'shipping', 'discount', 'discount_code', 'shipping_method', 'tax_rate', 'status', 'send_shipping_info_email', 'shipment_company', 'shipment_tracking_number', 'billing_address', 'billing_address_2', 'billing_city', 'billing_company', 'billing_country', 'billing_name', 'billing_phone', 'billing_state', 'billing_zip', 'email', 'shipping_address', 'shipping_address_2', 'shipping_city', 'shipping_company', 'shipping_country', 'shipping_method', 'shipping_name', 'shipping_phone', 'shipping_state', 'shipping_zip'),
  'api/site/v1/store_discount_codes/create' => array('code', 'country', 'custom', 'description', 'discount_shipping', 'fixed_amount', 'free_shipping', 'max_per_customer', 'min_order_amount', 'min_order_items', 'number_available', 'percentage_amount', 'start_at', 'stop_at', 'voucher', 'included_classes', 'excluded_classes', 'required_classes', 'free_shipping_method', 'manually_approve_orders'),
  'api/site/v1/store_discount_codes/update' => array('code', 'country', 'custom', 'description', 'discount_shipping', 'fixed_amount', 'free_shipping', 'max_per_customer', 'min_order_amount', 'min_order_items', 'number_available', 'percentage_amount', 'start_at', 'stop_at', 'voucher', 'included_classes', 'excluded_classes', 'required_classes', 'free_shipping_method', 'manually_approve_orders'),
  'api/site/v1/store_tax_rates/create' => array('description', 'rate', 'tax_class', 'minimum_price', 'minimum_subtotal', 'country', 'state', 'zip', 'include_shipping'),
