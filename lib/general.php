...
function _vae_handleob($vaeml) {
  ...
  try {
    ...
    if ($_SERVER['SERVER_ADDR'] != '127.0.0.1' && $_SESSION['__v:pre_ssl_host'] && _vae_ssl() && !$_VAE['ssl_required'] && !$_VAE['local_full_stack'] && !$_REQUEST['__vae_local'] && !$_REQUEST['__verb_local'] && !$_REQUEST['__xhr'] && strtolower($_SERVER['HTTP_X_REQUESTED_WITH'])!='xmlhttprequest') {
