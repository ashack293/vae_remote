...
function vae_staging() {
  ...
  if (strstr($_SERVER['SCRIPT_FILENAME'], ".verb/httpdocs/") && $_SERVER['DOCUMENT_ROOT'] == "") return true;
  ...
  if ($_SERVER['HTTP_HOST'] == "www" . $_VAE['settings']['subdomain'] . ".vaesite.com") return true;
